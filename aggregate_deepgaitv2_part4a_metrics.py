#!/usr/bin/env python3
"""
Aggregate metrics for DeepGaitV2 Part 4a models (B1, B2, B4) across k-folds.
...
MODEL_CONFIGS = {
    'B1': {  # Early Frozen (Partially Frozen)
        1: 500,
        2: 4500,
        3: 6500,
        4: 6500,
...
MODEL_DIR_PATTERNS = {
    'B1': 'REDO_Frailty_ccpg_pt4a_deepgaitv2_B1_partially_frozen_fold',
    'B2': 'REDO_Frailty_ccpg_pt4a_deepgaitv2_B2_partially_frozen_with_weights_fold',
    'B4': 'REDO_Frailty_ccpg_pt4a_deepgaitv2_B4_unfrozen_with_weights_fold'
}
...
def print_summary(all_results):
    ...
    print(f"\n{'='*80}")
    print("DEEPGaitV2 PART 4A METRICS SUMMARY (FULL)")
    print(f"{'='*80}\n")
...
def main():
    ...
    json_file = os.path.join(output_dir, 'deepgaitv2_part4a_aggregated_metrics.json')
