#!/usr/bin/env python3
"""
Aggregate metrics for SwinGait B3 unfrozen model across k-folds.
...
MODEL_DIR_PATTERN = 'REDO_Frailty_ccpg_pt4a_swingait_B3_unfrozen_cnn_fold'
...
def aggregate_metrics():
    ...
    print(f"\n{'='*80}")
    print("Processing SwinGait B3 Unfrozen")
    print(f"{'='*80}")
...
def print_focused_summary(results):
    ...
    print(f"\n{'='*80}")
    print("FOCUSED METRICS SUMMARY - SwinGait B3 Unfrozen")
    ...
    print(f"{'SwinGait B3 Unfrozen':<30} {acc_str:<20} {kappa_str:<20} {auc_macro_str:<20} {auc_micro_str:<20}")
...
def main():
    ...
    json_file = os.path.join(output_dir, 'swingait_b3_unfrozen_aggregated_metrics.json')
