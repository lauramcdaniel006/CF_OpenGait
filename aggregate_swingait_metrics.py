#!/usr/bin/env python3
"""
Aggregate metrics for SwinGait models across k-folds.
...
def print_summary(all_results):
    ...
    print(f"\n{'='*80}")
    print("SWINGAIT METRICS SUMMARY (FULL)")
    print(f"{'='*80}\n")
...
def main():
    ...
    json_file = os.path.join(output_dir, 'swingait_aggregated_metrics.json')
